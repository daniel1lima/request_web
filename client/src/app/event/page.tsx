...
const Index = () => {
  return (
    <div className="bg-white flex max-w-[480px] w-full h-screen flex-col overflow-y-auto items-center mx-auto">
      <EventHeader />
      ...
      <div className="flex flex-col items-center w-full px-4 pb-20">
        ...
        <h2 className="text-[#120D26] text-lg font-medium leading-[34px] opacity-[0.84] mt-[21px]">
          Song Queue
        </h2>

        <div className="flex flex-col gap-[13px] w-full items-center overflow-scroll">
          <SongCard
            image=""
            title="Healing"
            artist="Drake, Gordo"
      ...
      <div className="fixed bottom-0 w-full max-w-[480px] bg-transparent pb-4">
        <div className="self-stretch w-full text-base text-white font-bold text-center uppercase tracking-[1px] mt-[60px] pt-[9px] pb-5 px-[52px] bg-transparent">
          <Link href="/request-song">
            <button className="bg-[rgba(86,105,255,1)] shadow-[0px_10px_35px_rgba(111,126,201,0.25)] fill-[#5669FF] w-full px-[43px] py-[19px] rounded-[15px]">
              Request a song
            </button>
          </Link>
        </div>
